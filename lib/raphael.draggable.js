...
(function() {  
  ...
  var DraggableExtension = function (element) {
    ...
    this.onstartdrag = function(){console.log('onstartdrag called');console.log(this)}
    this.onmovedrag = function(){}
    ...
    element.mousedown(function(event) {
      ...
      var cur = paper.draggable.current();
      cur.draggable.onstartdrag.call(cur);
    ...
    document.onmouseup = function() {
    	var cur = paper.draggable.current();
    	if(cur){
    	  cur.draggable.onenddrag.call(cur);
    	}
    ...
    function startDragger() {
      document.onmousemove = function(event) {
        ...
        if (cur) {
          ...
          cur.translate(transX, transY);
          lastDragX = event.clientX;
          lastDragY = event.clientY;
          
          cur.draggable.onmovedrag.call(cur);
        }
      };
    }
  };
